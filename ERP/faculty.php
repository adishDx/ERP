<?php session_start();
    ...
    $query="select * from faculty where username='".$_SESSION['username']."'";
...
<head>
  <meta charset="UTF-8">
  <title>ERP | <?php echo $_SESSION["name"]; ?></title>
...
<body>
      ...
      <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation">
            <ul class="nav sidebar-nav">
                ...
                <li>
                    <a href="uploadattendance.php"><i class="fa fa-fw fa-folder"></i>Upload Attendance</a>
                </li>
                <li>
                    <a href="uploadmarks.php"><i class="fa fa-fw fa-file-o"></i>Upload Exam Marks</a>
                </li>
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
          ...
          <div class="panel panel-info">
            <div class="panel-heading">
              <h3 class="panel-title"><?php echo $row[0]; ?></h3>
            </div>
  ...
  <form class="modal-content" action="changepassfaculty.php" method="post">
                <div class="container">
